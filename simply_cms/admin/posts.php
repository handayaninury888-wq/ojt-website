...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <a href="add_post.php" class="btn-primary"><i class="fas fa-plus"></i> Tambah Baru</a>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    while ($post = mysqli_fetch_assoc($posts_result)) {
                        ...
                        echo "<a href='delete_post.php?id=" . $post['id'] . "' class='delete' onclick='return confirm(\"Yakin hapus postingan ini?\")'>Hapus</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
        ...
        <?php else: ?>
            <div class="empty">
                ...
                <a href="add_post.php" class="btn-primary" style="margin-top: 1rem;">Buat Postingan Pertama</a>
            </div>
        <?php endif; ?>
    </div>
